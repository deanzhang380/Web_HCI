  ...
  return (
    <div className="profileModal" >
      <Modal
        ...
        toggle={toggle}
        className={className}
        style={{ maxWidth: '1000px', maxHeight: "1500px", width: '100%', maxHeight: '1000px', height: 'fit-content', margin: '10px auto' }}  >
